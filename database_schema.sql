...
-- Insert initial welcome messages introducing usage rules
INSERT INTO messages (user_id, nickname, content, is_anonymous, created_at) VALUES
(1, 'admin', '🎉 欢迎使用在线留言板系统！\n\n本留言板旨在为大家提供一个自由、友好的交流平台。请遵守以下使用规范，共同营造良好的交流环境。', FALSE, DATE_SUB(NOW(), INTERVAL 5 MINUTE)),

(1, 'admin', '📋 使用规范：\n\n1️⃣ 文明发言：请使用文明礼貌的语言，禁止发布侮辱、诽谤、歧视等不当内容\n2️⃣ 尊重他人：尊重他人的观点和隐私，不得恶意攻击或骚扰其他用户\n3️⃣ 内容合法：禁止发布违法违规信息，包括但不限于色情、暴力、赌博等内容', FALSE, DATE_SUB(NOW(), INTERVAL 4 MINUTE)),

(1, 'admin', '✨ 功能说明：\n\n• 匿名留言：未登录用户可以匿名发表留言，需要输入昵称和验证码\n• 注册用户：注册登录后可以直接发表留言，无需验证码\n• 编辑删除：注册用户可以编辑和删除自己发表的留言\n• 图片上传：支持上传图片和表情包，让交流更生动有趣', FALSE, DATE_SUB(NOW(), INTERVAL 3 MINUTE)),

(1, 'admin', '🔒 安全提示：\n\n• 请妥善保管您的账号密码，不要将密码告诉他人\n• 系统已启用多重安全防护，包括SQL注入防护、XSS攻击防护等\n• 如发现任何安全问题，请及时联系管理员\n• 定期修改密码可以提高账号安全性', FALSE, DATE_SUB(NOW(), INTERVAL 2 MINUTE)),

(1, 'admin', '💡 温馨提示：\n\n• 留言按照时间倒序显示，最新的留言会出现在最前面\n• 支持分页浏览，每页显示10条留言\n• 管理员会定期清理违规内容，请自觉遵守规范\n• 如有任何建议或问题，欢迎在留言板中反馈\n\n祝大家使用愉快！😊', FALSE, DATE_SUB(NOW(), INTERVAL 1 MINUTE));
